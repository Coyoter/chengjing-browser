...
class CertificateWarningsTest {
    ...
    @Test fun mainDocumentBeforeNavigationHasAWarning(){val w=CertificateWarnings();w.record("","https://invalid.example.com/","憑證來源不受信任");assertTrue(w.messageFor("https://invalid.example.com/").contains("已依設定繼續載入"))}
