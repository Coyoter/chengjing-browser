#!/usr/bin/env python3
"""Exercise the uninstrumented optimized APK via six independent test-host processes."""
...
print("All six checks passed against the actual non-debuggable R8 APK, without adding app test keep rules.")
